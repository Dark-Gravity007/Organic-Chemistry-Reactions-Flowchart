...
# Organic Chemistry Reaction Flowcharts 🧪
...
1.  **Alkyl Halide Network (R–X):** The central hub for nucleophilic substitution, Grignard reagents, and name reactions like Finkelstein and Swarts.
    
2.  **Carbonyl Group (≥C=O):** Detailed pathways for Aldehydes and Ketones, including Reduction (Clemmensen, Wolff-Kishner), Nucleophilic Addition, and condensation reactions (Aldol, Cannizzaro).
    
3.  **Benzene & Phenol:** Electrophilic Aromatic Substitution (EAS) routes, side-chain reactions of Toluene, and specific Phenol tests.
    
4.  **Aniline & Diazonium Salts:** The "Bridge of Organic Chemistry"—showing how to transform Aniline into various aromatic compounds via Diazonium intermediates.
...
- Reactions are structured in `row` and `branch-indent` classes.
    
- Styling is handled via semantic classes like `.box-green` (alcohols) or `.box-purple` (aromatics).
